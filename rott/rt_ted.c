         ...
         while (lastmem<=currentmem)
            {//SetTextMode (  );
   			if ( iGLOBAL_SCREENWIDTH == 320) {
				...
				DrawNormalSprite (72+(Gs*(lastmem<<2)),372,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+(Gs*(lastmem<<2)),372+3,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+3+(Gs*(lastmem<<2)),372,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+3+(Gs*(lastmem<<2)),372+3,W_GetNumForName ("led1"));//led1 progressbar
			}
         ...
         while (lastcache<=currentcache)
            {
   			...
   			if ( iGLOBAL_SCREENWIDTH == 320) {
				...
				DrawNormalSprite (72+(Gs*(lastcache<<2)),382,W_GetNumForName ("led2"));//led2 progressbar
				DrawNormalSprite (72+(Gs*(lastcache<<2)),382+3,W_GetNumForName ("led2"));//led2 progressbar
				DrawNormalSprite (72+3+(Gs*(lastcache<<2)),382,W_GetNumForName ("led2"));//led2 progressbar
				DrawNormalSprite (72+3+(Gs*(lastcache<<2)),382+3,W_GetNumForName ("led2"));//led2 progressbar
