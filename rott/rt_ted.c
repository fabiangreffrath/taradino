         ...
         while (lastmem<=currentmem)
            {//SetTextMode (  );
   			if ( iGLOBAL_SCREENWIDTH == 320) {
				...
				DrawNormalSprite (72+(Gs*(lastmem<<2)),366,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+(Gs*(lastmem<<2)),366+3,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+3+(Gs*(lastmem<<2)),366,W_GetNumForName ("led1"));//led1 progressbar
				DrawNormalSprite (72+3+(Gs*(lastmem<<2)),366+3,W_GetNumForName ("led1"));//led1 progressbar
			}
