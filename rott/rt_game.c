...
void StatusDrawPic(unsigned int x, unsigned int y, pic_t *nums,
...
void StatusDrawColoredPic(unsigned int x, unsigned int y, pic_t *nums,
...
void StatusDrawTime(unsigned int x, unsigned int y, unsigned int num,
					boolean bufferofsonly)
